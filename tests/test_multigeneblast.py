...
if __name__ == "__main__":
    ...
    command1 = "..{}multigeneblast.py -in test_querys{}V_maris_query.gb -from 0 -to 59320 -out tests{}test_run_gbk -db test_data_base{}v_maris.pal -c 4 -hpg 200 -msc 25 -mpi 30 -dkb 20 -sw 0.5 -m n -op 3 -inf all".format(os.sep, os.sep, os.sep, os.sep)
    ...
    command2 = "..{}multigeneblast.py -in test_querys{}V_maris_query.embl -from 0 -to 59320 -out tests{}test_run_embl -db test_data_base{}v_maris.pal -c 4 -hpg 200 -msc 25 -mpi 30 -dkb 20 -sw 0.5 -m n -op 3 -inf all".format(os.sep, os.sep, os.sep, os.sep)
    ...
    command3 = "..{}multigeneblast.py -in test_querys{}V_maris_query_partial.fasta -out tests{}test_run_fasta -db test_data_base{}v_maris.pal -c 4 -hpg 200 -msc 25 -mpi 30 -dkb 20 -sw 0.5 -m n -op 3 -inf all".format(os.sep, os.sep, os.sep, os.sep)
    ...
    command4 = "..{}multigeneblast.py -in test_querys{}V_maris_query.gb -from 0 -to 59320 -out tests{}test_run_gbk -db test_data_base{}v_maris_nuc.nal -c 4 -hpg 200 -msc 25 -mpi 30 -dkb 20 -sw 0.5 -m n -op 3 -inf all".format(os.sep, os.sep, os.sep, os.sep)
    ...
    command5 = "..{}multigeneblast.py -in test_querys{}V_maris_query.embl -from 0 -to 59320 -out tests{}test_run_embl -db test_data_base{}v_maris_nuc.nal -c 4 -hpg 200 -msc 25 -mpi 30 -dkb 20 -sw 0.5 -m n -op 3 -inf all".format(os.sep, os.sep, os.sep, os.sep)
    ...
    command6 = "..{}multigeneblast.py -in test_querys{}V_maris_query_partial.fasta -out tests{}test_run_fasta -db test_data_base{}v_maris_nuc.nal -c 4 -hpg 200 -msc 25 -mpi 30 -dkb 20 -sw 0.5 -m n -op 3 -inf all".format(os.sep, os.sep, os.sep, os.sep)
    ...
    command7 = "..{}multigeneblast.py -in test_querys{}V_maris_query.gb -out tests{}test_run_fasta -from 0 -to 59320 -db test_data_base{}mix.nal -c 4 -hpg 200 -msc 25 -mpi 30 -dkb 20 -sw 0.5 -m n -op 3 -inf all".format(os.sep, os.sep, os.sep, os.sep)
